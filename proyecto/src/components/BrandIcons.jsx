/*
  Íconos de marca (GitHub, LinkedIn) como SVG inline.
  lucide-react ya no exporta íconos de marca, así que se definen aquí
  con la misma API mínima (size) usando currentColor.
*/
