...
function TestimonialCard({ item, index }) {
  ...
  return (
    <motion.article
      ...
      className="min-w-[min(100%,20rem)] shrink-0 snap-start sm:min-w-0"
    >
      <span className="font-mono text-3xl leading-none text-orange" aria-hidden="true">
        {'>'}
      </span>
      <blockquote className="mt-4 max-w-prose">
        <p className="font-body text-base leading-relaxed text-carbon">
...
export default function Testimonials() {
  ...
  return (
    <div className="mt-20 border-t border-line pt-12">
      ...
      <div className="mt-8 flex gap-8 overflow-x-auto pb-2 snap-x snap-mandatory sm:grid sm:grid-cols-3 sm:overflow-visible sm:pb-0">
